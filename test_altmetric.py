...
class TestAltmetric(TestCase):
    ...
    def test_article_from_pmid(self):
    ...
    def test_article_from_altmetric(self):
    ...
    def test_article_from_ads(self):
    ...
    def test_article_from_arxiv(self):
    ...
    def test_articles_from_timeframe(self):
